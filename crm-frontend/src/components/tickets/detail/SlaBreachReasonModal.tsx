        ...
        <div className="flex flex-col gap-3 px-6 py-5">
          <div className="grid grid-cols-3 items-center gap-3">
            ...
            <select
              ...
              className="col-span-2 h-9 w-full rounded-lg border border-slate-300 bg-white px-2 text-xs outline-none focus:border-sky-400"
            >
          ...
          <div className="grid grid-cols-3 items-start gap-3">
            ...
            <textarea
              ...
              rows={3}
              className="col-span-2 w-full rounded-lg border border-slate-300 px-3 py-2 text-xs outline-none focus:border-sky-400"
            />
          </div>
