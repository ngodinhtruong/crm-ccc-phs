...
> = {
  ...
  SALE_ADMIN: {
    ...
    sa_customers: [
      {
        title: "KHÁCH HÀNG SALE ADMIN",
        items: [
          {
            title: "Khách hàng Inactive",
            href: "/sale-admin/customers",
            icon: UsersRound,
          },
          {
            title: "Customer 360",
            href: "/sale-admin/customers/360",
            icon: Users,
          },
        ],
      },
    ...
    sa_kpi: [
      {
        ...
        items: [
          ...
          {
            title: "Báo cáo chất lượng Reactivation",
            href: "/sale-admin/kpi/reactivation-quality",
            icon: FileBarChart,
          },
        ],
      },
...
export function MainNavigationDrawer({
  ...
  const mainMenuItems = mainMenuItemsByWorkspace[activeWorkspace];
  const panelGroups = panelGroupsByWorkspace[activeWorkspace];
        ...
        <div className="h-screen w-[200px] border-r border-white/10 bg-[#263747]">
          ...
          <div className="border-b border-white/10 px-4 py-3">
            <button
              ...
              className="w-full rounded-md border border-white/10 bg-white/[0.04] px-3 py-2 text-left hover:bg-white/10"
            >
              <div className="text-[10px] font-semibold uppercase tracking-wide text-white/40">
                Phân hệ hiện tại
              </div>

              <div className="mt-1 text-[13px] font-bold text-[#b9d8e8]">
                {WORKSPACE_LABEL[activeWorkspace]}
              </div>

              <div className="mt-0.5 text-[11px] text-white/45">
                Bấm để chuyển phân hệ
              </div>
            </button>
          </div>
