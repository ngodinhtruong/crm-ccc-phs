...
function DashboardToolbar({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div className="flex flex-col gap-3 border-b border-slate-100 px-4 py-4 xl:flex-row xl:items-center xl:justify-between">
        <div>
          <h1 className="flex items-center gap-2 text-lg font-bold text-slate-800">
            <Bot size={21} className="text-sky-600" />
            Dashboard Chatbot
          </h1>
      ...
      <div className="grid grid-cols-1 gap-3 px-4 py-4 md:grid-cols-2 xl:grid-cols-8">
        <ToolbarField
          label="Năm"
          value={filters.year || ""}
        ...
        <div className="flex items-end xl:col-span-2">
          <button
            type="button"
            onClick={onApply}
            className="flex h-10 w-full items-center justify-center gap-2 rounded-lg bg-[#0097cf] px-4 text-sm font-semibold text-white transition hover:bg-[#0089bd]"
          >
            <Filter size={16} />
            Lọc dữ liệu
          </button>
...
function QuickPresetButton({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="inline-flex h-9 items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 text-xs font-semibold text-slate-700 transition hover:border-sky-300 hover:bg-sky-50 hover:text-sky-700"
    >
  ...
  return (
    <div>
      ...
      <input
        ...
        className="h-10 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm text-slate-700 outline-none transition focus:border-sky-400 focus:ring-2 focus:ring-sky-100"
      />
    </div>
  );
}
