...
Job chạy nền theo lịch (Celery beat). Ticket chatbot giờ nằm chung bảng
`tickets` nên chỉ còn MỘT vòng quét duy nhất qua TicketSlaTracking, thay vì
hai vòng làm cùng một việc như trước.
